...
export const BETA = [
  ...
  },
  {
    ...
    note: '«плинь, плиньк, буп»: у каждого цвета свой голос, линия тикает вверх, соединил — «плиньк», перерезал — «буп», уровень — «плинь» по парам, тиканье последних 5 секунд; кнопка звука',
